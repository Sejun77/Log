...
Phase 9 is **not closed** — 9-C / 9-D / 9-E are still pending. Shipped so far: pre-9 cleanup (8-C), 9-pre regression tests, **9-A** in full (9-A1 hydration service + 9-A2 bootstrap wiring), **9-A.5 audit decisions** (planning), and **9-B** in full (9-B1 routine-editor reads + 9-B2 ActiveWorkout swap path incl. follow-up swap/resume/timer fixes). Sub-slices are independently revertible. Recommended ship spacing: **9-pre tests** ✅ → **9-pre diagnostic** (TestFlight; recommended before 9-C, REQUIRED before 9-E) → **9-A1** ✅ → **9-A2** ✅ → **9-A.5 audit decisions** ✅ → **9-B1** ✅ → **9-B2** ✅ → release gap + observe diagnostic → **9-C** → **9-D** → **9-E pre-flight migration decision** (gated on diagnostic counters c/d) → **9-E field deletion**.
