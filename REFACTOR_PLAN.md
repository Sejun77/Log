...
- [ ] Expected `ActiveWorkoutView.swift` reduction: 3,061 (post-11.4 baseline) → ~2,000–2,300. Concrete reduction depends on how the extension files are split and whether any tiny helpers stay co-located with `body`
...
|---|---:|---:|---:|---:|---:|---:|---:|
| `ActiveWorkoutView.swift` | 3,849 | **3,695** | 3,695 | 3,695 | **3,061** | 3,061 | ~2,000–2,300 |
