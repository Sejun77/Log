...
extension UserGuideView {
    ...
    static let englishGuide: [GuideSection] = [
        ...
        GuideSection(
            ...
            intro: "An effort target says how hard a working set should feel, written as RIR or RPE (choose which in Settings). A routine exercise can set targets three ways:",
            items: [
    ...
    static let koreanGuide: [GuideSection] = [
        ...
        GuideSection(
            heading: "운동 강도 목표",
            intro: "운동 강도 목표는 각 작업 세트를 얼마나 힘들게 수행할지 RIR 또는 RPE로 나타냅니다(설정에서 방식을 선택합니다). 루틴의 운동마다 세 가지 방식으로 설정할 수 있습니다.",
            items: [
