...
// `ActiveWorkoutGuard` — moved to `Log/Services/ActiveWorkoutGuard.swift` (Phase 11.1).
// `SessionPlan`         — moved to `Log/Models/SessionPlan.swift` (Phase 11.1).
// `Collection.safe`     — moved to `Log/Utilities/Collection+Safe.swift` (Phase 11.1).
