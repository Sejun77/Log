...
// Access is `internal` so `SlotPrescriptionSection` (relocated to
// `Log/Main/Routines/PrescriptionFields.swift` in Phase 11.2) can
// navigate to this editor across files. Slated to move to its own
// file in Phase 11.3 alongside the rest of the technique editor stack.
