...
1. Open the app.
2. Go to Exercises to check or create exercises.
3. Go to Routines to create or select a workout plan.
4. Start a workout from a routine.
5. Log each set as you train.
6. Finish the workout.
7. Check History to review what you completed.
...
4. Choose the body part and equipment.
5. Choose whether the exercise uses reps or duration.
6. For bodyweight exercises, choose whether bodyweight should count as load.
7. Add exercise notes or setup notes if needed.

## Organizing Exercises

In the Exercises tab, you can organize the exercise list in different ways:
...
1. Open a routine.
2. Tap Start Workout.
3. Enter reps and weight for each set.
4. Tap Log after completing a set.
5. Rest when the timer starts.
6. Record notes about the session if needed.
7. Switch exercises, edit the workout plan, edit setup notes, or edit exercise notes if needed.
...
Cardio exercises also let you record details such as distance, calories, heart
rate, incline or decline, resistance, and heart-rate zone. In routines, cardio
exercises can have a target distance and an optional Cardio Plan. To make your
own cardio exercise, open the exercise, turn on Time-based, then turn on Cardio.

A Cardio Plan is only a guide/checklist. Your workout is still saved as one
Cardio Set using the duration and Details you log.
...
This is useful if a workout was unusual, such as a deload, recovery day, or incomplete session, and you do not want it to affect future workout suggestions.
...
instead — e1RM and volume need a weight, so they are not offered.

Cardio history shows your logged cardio results and any Cardio Plan that was
...
1. 앱을 엽니다.
2. 운동 탭에서 운동을 확인하거나 새로 추가합니다.
3. 루틴 탭에서 운동 계획을 만들거나 선택합니다.
4. 루틴에서 운동을 시작합니다.
5. 운동하면서 각 세트를 기록합니다.
6. 운동을 완료합니다.
7. 기록 탭에서 완료한 운동을 확인합니다.
...
3. 운동 이름을 입력합니다.
4. 부위와 장비를 선택합니다.
5. 반복 횟수로 기록할지, 시간으로 기록할지 선택합니다.
6. 맨몸 운동의 경우 체중을 중량에 포함할지 선택합니다.
7. 필요하면 운동 메모나 세팅 메모를 추가합니다.

## 운동 정리하기

운동 탭에서는 운동 목록을 여러 방식으로 정리할 수 있습니다.
...
1. 루틴을 엽니다.
2. 운동 시작을 누릅니다.
3. 각 세트의 반복 횟수와 중량을 입력합니다.
4. 세트를 완료한 뒤 기록을 누릅니다.
5. 타이머가 시작되면 휴식합니다.
6. 필요하면 세션 메모를 기록합니다.
7. 필요하면 운동을 교체하거나, 운동 계획을 수정하거나, 세팅 메모 또는 운동 메모를 수정합니다.
8. 완료를 누른 뒤 확인하면 운동이 기록에 저장됩니다.
...
유산소 운동에서는 거리, 칼로리, 심박수, 경사 / 내리막, 저항, 심박 존 같은 세부 정보도
기록할 수 있습니다. 루틴에서는 유산소 운동에 목표 거리와 유산소 계획을 설정할 수
있습니다. 직접 유산소 운동을 만들려면 해당 운동을 열고 시간 기반을 켠 다음 유산소를
켜세요.

유산소 계획은 안내용 체크리스트일 뿐입니다. 운동은 기록한 시간과 세부 정보를 바탕으로
유산소 세트 하나로 저장됩니다.
...
이 기능은 디로드, 회복 운동, 미완성 운동처럼 평소 기록으로 사용하고 싶지 않은 운동을 제외할 때 유용합니다.

## 기록 확인하기

기록 탭에서는 완료한 운동을 확인할 수 있습니다.
